...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { genre: @anime.genre, note: @anime.note, studio: @anime.studio, titre: @anime.titre } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { genre: @anime.genre, note: @anime.note, studio: @anime.studio, titre: @anime.titre } }
